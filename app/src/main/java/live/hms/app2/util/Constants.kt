...
val REGEX_MEETING_URL_CODE = Regex("https?://.*/meeting/([a-zA-Z0-9]+-[a-zA-Z0-9]+-[a-zA-Z0-9]+)/?")
val REGEX_MEETING_URL_ROOM_ID = Regex("https?://.*/meeting/([a-zA-Z0-9]+)/([a-zA-Z0-9]+)/?")

val REGEX_TOKEN_ENDPOINT = Regex("https?://.*.100ms.live/hmsapi/([a-zA-Z0-9-.]+)/?")
